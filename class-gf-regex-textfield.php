...
class GFRegexTextfield extends GFAddOn
{
     ...
     * Class instance
     *
     * @var GFRegexTextfield|null $_instance If available, contains an instance of this class.
     */
    private static $_instance = null;
    protected $_version = GF_Regex_Textfield_VERSION;
    protected $_min_gravityforms_version = '2.5';
    protected $_slug = 'regex-textfield-gravityforms';
    protected $_path = 'regex-textfield-gravityforms-add-on/gf-regex-textfield.php';
    protected $_full_path = __FILE__;
    protected $_url = 'https://peshmerge.io';
    protected $_title = 'GravityForms Regex textfield Add-On';
